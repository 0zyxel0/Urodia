@extends('master\layout-profile') @section('content')
  ...
  <div class="right_col" role="main">
    ...
    <div class="clearfix"></div>
      <form id="demo-form" action="http://localhost:8899/urodia/public/show" method="post">
    <div class="x_panel">
          ...
          <div class="funkyradio">
            ...
            <ul style="list-style: none; display:none;" class="children-2">
              ...
              <li>
                ...
                <label for="sui_tot_rupc">Open Retropubic Urethropexy Complicated Secondary Repair Secondary (Burch, MMK)
                </label>
              </li>
            </ul>
          </div>
